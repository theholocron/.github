...
* Go to "Pull requests" and open a new pull request with your changes and fill out the template with the appropriate information.
...
| `npm run build:js` | Runs the compiler the JS(X) into JS | <https://babeljs.io>
