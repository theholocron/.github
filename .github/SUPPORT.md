...
1. Open a support request ticket from the "Issues" tab or reach out via [email](mailto:github-support@theholocron.dev).
...
If you're a maintainer and need some guidance on how things are done, please read our guide (found at `./.github/MAINTAINING.md`) within each repository.
